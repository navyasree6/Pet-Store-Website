...
<div class= "rightcolumn">
	<img src="images/petstoreimage.png" alt="petstoreimage" width="100%" >
	<form  name="myForm" method ="POST" action="#" autocomplete="off" onsubmit="return (validateForm());">	
		<h2>Client</h2>
	...
	<table class= "container" cellspacing="15" >
		<tr>
			<td >* First Name:</td>
			<td>
				<input type="text" name="FirstName" maxlength="30" required  /></td>
		</tr>
		<tr>
			<td>* Last Name:</td>
			<td>
				<input type="text" name="LastName" maxlength="30" required="required"  /></td>
			</td>
		</tr>
		<tr>
			<td>* E-mail:</td> 
			<td>
				<input type="Email" name="Email"  maxlength="30" required /></td>
			</td>
		</tr>
		<tr>
			<td>Phone:</td>
			<td>
				<input type="text" name="Phone" maxlength="12" /></td>
			</td>
		</tr>
		<tr>
			<td>Business Name:</td>
		...
		<tr>
			<td>
				<input type="Submit" name="sendmail"value="Submit"/></td>
			</td>
		</tr>
